...
def generate_image(prompt, selected_concept, blur_background):
    return textualInversion.generate_image(prompt, display_choices.index(selected_concept), background_blur=blur_background)
...
demo = gr.Interface(
    ...
    inputs=[
        ...
        gr.Checkbox(label="Blur Background", value=False)
    ],
